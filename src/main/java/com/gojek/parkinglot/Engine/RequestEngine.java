...
public class RequestEngine implements AbstractEngine {
    ...
    private ServiceEngine parkingService;

    public void setParkingService(ServiceEngine parkingService) throws ParkingException
    {
    ...
    @Override
    public void setService(ServiceEngine service)
    {
